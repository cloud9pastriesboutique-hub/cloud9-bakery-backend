...
/*const transporter = nodemailer.createTransport({
  ...
  secure: false, // Brevo uses TLS STARTTLS on port 587
  auth: {
...
// ---------------------------
// ---------------------------
// SEND EMAIL TO USER USING BREVO
// ---------------------------
try {
  const sendSmtpEmail = new Brevo.SendSmtpEmail();

  sendSmtpEmail.sender = { 
    name: "Cloud 9 Pastries", 
    email: "cloud9pastries.boutique@gmail.com" 
  };

  sendSmtpEmail.to = [{ email: email }];

  sendSmtpEmail.subject = "Order Confirmation - Cloud 9 Pastries";
  ...
  console.log("❌ Email API Error:", e.response?.text || e.message);
}
